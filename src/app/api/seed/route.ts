...
export async function GET(request: Request) {
  ...
  await prisma.user.create({
    data: {
      ...
      roles: ["admin"],
      image:
        "https://static.wikia.nocookie.net/vampirediaries/images/f/f0/Legacies-S4-Caroline.png/revision/latest?cb=20220618183451",
  ...
  await prisma.user.create({
    data: {
      ...
      roles: ["user"],
      image:
        "https://static.wikia.nocookie.net/vampirediaries/images/1/16/Damon-S8.jpg/revision/latest?cb=20170225081735",
  ...
  await prisma.user.create({
    data: {
      ...
      roles: ["super-user"],
      image:
        "https://static.wikia.nocookie.net/vampirediaries/images/7/74/Katherine-S8.jpg/revision/latest?cb=20170313214107",
