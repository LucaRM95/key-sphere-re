...
export async function GET(request: Request) {
  ...
  await prisma.user.create({
    data: {
      ...
      roles: ["admin"],
      image: "https://static.wikia.nocookie.net/vampirediaries/images/f/f0/Legacies-S4-Caroline.png/revision/latest?cb=20220618183451",
  ...
  await prisma.user.create({
    data: {
      ...
      image: "https://static.wikia.nocookie.net/vampirediaries/images/3/3c/Stefan_Vamped_Out.jpg/revision/latest/scale-to-width-down/1000?cb=20130809062739",
      ...
      properties: {
        create: [
          ...
          },
          {
            ...
            description:
              "Stylish apartment in the heart of Palermo, Buenos Aires.",
  ...
  await prisma.user.create({
    data: {
      ...
      roles: ["user"],
      image: "https://static.wikia.nocookie.net/vampirediaries/images/1/16/Damon-S8.jpg/revision/latest?cb=20170225081735",
        ...
        create: [
          {
            ...
            description:
              "Charming home in the countryside with mountain views.",
  ...
  await prisma.user.create({
    data: {
      ...
      roles: ["super-user"],
      image: "https://static.wikia.nocookie.net/vampirediaries/images/7/74/Katherine-S8.jpg/revision/latest?cb=20170313214107",
      ...
      properties: {
        create: [
          ...
          },
          {
            ...
            description:
              "Beautiful villa surrounded by nature in the countryside.",
